...
<html lang="en-US">
  ...
  <tr>
       ...
       <?php
          ...
          $s="SELECT * from tbl_item inner join tbl_itemchild on tbl_itemchild.icode=tbl_item.icode";
...
<tr>
  ...
  <td><a href="edititemc1.php?ino=<?php echo $row['ino'];?>" style="color:blue">Edit</a>|<a href="delitemc.php?ino=<?php echo $row['ino'];?>" style="color:red">Delete</a>
</tr>
<?php } ?>
</table></div>
