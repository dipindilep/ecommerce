...
.hover figure:hover img {
   ...
   <body class="size-1140">
      ...
      <section>
			   ...
			   <?php
        $s="SELECT * from tbl_item inner join tbl_brand on tbl_brand.bcode=tbl_item.bcode where vcode='".$_GET['bc']."'";
        $s2="SELECT * from tbl_variety  where vcode='".$_GET['bc']."'";
