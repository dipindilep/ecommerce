...
<html lang="en-US">
   ...
   <body class="size-1140">
     ...
     <form action="payaction.php" class="customform" >
     ...
     <?php
		 ...
		 // $sid=$_SESSION['uid'];
		  $oid=$_GET['oid'];
          $s="SELECT * from tbl_orderm where oid='$oid'";
          $rs=$db->selectData($s);
    ...
    <table>
     <input type="hidden" name="oid" value="<?php echo $row['oid'];?>"readonly/>
      ...
      <tr><th>Total Amount</th><td><input type="text"
                                              name="tamt" 
                                              value="<?php echo $row['trent'];?>" required ></td></tr>

		<tr><th>Advance Amount</th><td><input type="text"
                                              name="tadv" 
                                              value="<?php echo ($row['trent']/2);?>" required ></td></tr>
      <tr><th></th><td><input type="submit" value="Pay & Confirm Order"></td></tr>  
   </table>
